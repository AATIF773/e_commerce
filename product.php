				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">₹'.$row['product_price'].'<del class="product-old-price"> ₹'.$row['product_old_price'].'</del></h3>
							...
							<div class="product-options">
								...
								<div class="add-to-cart">
									...
									<button class="add-to-cart-btn" pid="'.$row['product_id'].'"  id="product" >Rent</button>
									</div>
								</div>
							</div>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Aatif</h5>
															<p class="date"3 APRIL 2021, 8:0 PM</p>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Ambreen</h5>
															<p class="date">28 MAR 2021, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Nayeem</h5>
															<p class="date">15 MAR 2018, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
