      ...
      <div class="content">
		...
		<a>
          ...
          <div class="col-md-6">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">Publishers List</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Publishers</th><th>Count</th>
                    </tr></thead>
                    <tbody>
                      <?php 
                        $result=mysqli_query($con,"select * from publishers")or die ("query 1 incorrect.....");
                        $i=1;
                        while(list($publisher_id,$publisher_title)=mysqli_fetch_array($result))
                        {	
                            ...
                            $count=$row["count_items"];
                            $i++;
                        echo "<tr><td>$publisher_id</td><td>$publisher_title</td><td>$count</td>
                  ...
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <tbody>
                      <?php 
                        ...
                        while(list($publisher_id,$publisher_title)=mysqli_fetch_array($result))
                        {	
                        echo "<tr><td>$publisher_id</td><td>$publisher_title</td>
